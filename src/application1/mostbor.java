...
public class mostbor  {
	public AnchorPane mostborpane() {
		try {
			...
			b5.setLayoutY(149.0);
			b5.setText("Search");
			TreeTableView<mostbor> tb = new TreeTableView<mostbor>();
			tb.setLayoutX(77.0);
			tb.setLayoutY(268.0);
			tb.setPrefHeight(200.0);
			tb.setPrefWidth(413.0);
			TreeTableColumn<mostbor,String> tc1=new TreeTableColumn<>("Ttile of the Book");
			tc1.setPrefWidth(267.0);
			TreeTableColumn<mostbor, String> tc2=new TreeTableColumn<>("Total No. of Time");
			...
			lb5.setLayoutX(77.0);
			lb5.setLayoutY(57.0);
			lb5.setText("Top Borrowed Books");
			Label lb3 = new Label();
			lb3.setFont(f3);
			lb3.setLayoutX(77.0);
			...
			ap1.getChildren().addAll(sp,lb1,lb2,lb3,lb5,b5,b10,cb,tb);
			ap1.minHeight(0);
			ap1.minWidth(0);
