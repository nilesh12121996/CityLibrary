...
public class popbook {
	public AnchorPane popbookpane() {
		try {
			...
			b5.setLayoutY(149.0);
			b5.setText("Search");
			TreeTableView<popbook> tb = new TreeTableView<popbook>();
			tb.setLayoutX(77.0);
			tb.setLayoutY(268.0);
			tb.setPrefHeight(200.0);
			tb.setPrefWidth(413.0);
			TreeTableColumn<popbook,String> tc1=new TreeTableColumn<>("Ttile of the Book");
			tc1.setPrefWidth(267.0);
			TreeTableColumn<popbook, String> tc2=new TreeTableColumn<>("Total No. of Time");
			...
			lb5.setLayoutX(77.0);
			lb5.setLayoutY(57.0);
			lb5.setText("Most Popular Books");
			Label lb3 = new Label();
			lb3.setFont(f3);
			lb3.setLayoutX(77.0);
